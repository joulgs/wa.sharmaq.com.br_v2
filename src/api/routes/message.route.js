...
const NumberCheck = require('../middlewares/numberCheck')
...
router.route('/text').post(keyVerify, loginVerify, SHTokenVerification, NumberCheck, controller.Text)
router.route('/doc').post(keyVerify, loginVerify, SHTokenVerification, upload, NumberCheck, controller.Document)
